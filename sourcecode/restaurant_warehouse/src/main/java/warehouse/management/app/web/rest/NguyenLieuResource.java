...
public class NguyenLieuResource {
    ...
    public NguyenLieuResource(NguyenLieuService nguyenLieuService, NguyenLieuRepository nguyenLieuRepository, NhomNguyenLieuService nhomNguyenLieuService, NhaCungCapService nhaCungCapService) {
...
//        log.debug("REST request to partial update NguyenLieu partially : {}, {}", id, nguyenLieuDTO);
        ...
        nguyenLieuDTO.setId(updateNguyenLieuRequest.getId());
        if (updateNguyenLieuRequest.getTenNguyenLieu() != null) {nguyenLieuDTO.setTenNguyenLieu(updateNguyenLieuRequest.getTenNguyenLieu());}

        if (updateNguyenLieuRequest.getDonViTinh() != null) {nguyenLieuDTO.setDonViTinh(updateNguyenLieuRequest.getDonViTinh());}
        if (updateNguyenLieuRequest.getGiaNhap() != null) {nguyenLieuDTO.setGiaNhap(updateNguyenLieuRequest.getGiaNhap()); log.debug("hello");}
        if (updateNguyenLieuRequest.getMoTa() != null) {nguyenLieuDTO.setMoTa(updateNguyenLieuRequest.getMoTa());}
        if (updateNguyenLieuRequest.getvAT() != null) {nguyenLieuDTO.setvAT(updateNguyenLieuRequest.getvAT());}
