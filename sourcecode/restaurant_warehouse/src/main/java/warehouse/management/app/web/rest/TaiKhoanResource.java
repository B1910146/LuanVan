...
public class TaiKhoanResource {
    ...
    public ResponseEntity<TaiKhoanDTO> createTaiKhoan(@Valid @RequestBody TaiKhoanRequest taiKhoanRequest) throws URISyntaxException, MessagingException {
...
//    }
    ...
    public ResponseEntity<?> authenticate(@Valid @RequestBody LoginVM loginVM) {
        ...
        UsernamePasswordAuthenticationToken authenticationToken =
            new UsernamePasswordAuthenticationToken(loginAccount.getId(), loginVM.getUsername());
