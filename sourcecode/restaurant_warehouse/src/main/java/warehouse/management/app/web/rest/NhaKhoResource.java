...
public class NhaKhoResource {
    ...
    public NhaKhoResource(NhaKhoService nhaKhoService, NhaKhoRepository nhaKhoRepository, ChiTietKhoService chiTietKhoService, ChiTietKhoRepository chiTietKhoRepository, NguyenLieuService nguyenLieuService) {
