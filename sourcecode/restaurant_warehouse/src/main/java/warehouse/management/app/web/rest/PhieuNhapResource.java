...
public class PhieuNhapResource {
    ...
    public PhieuNhapResource(PhieuNhapService phieuNhapService, PhieuNhapRepository phieuNhapRepository, ChiTietPhieuNhapService chiTietPhieuNhapService, ChiTietPhieuNhapRepository chiTietPhieuNhapRepository, NguyenLieuRepository nguyenLieuRepository, NguyenLieuService nguyenLieuService, NhaKhoService nhaKhoService, NhaCungCapService nhaCungCapService, TaiKhoanService taiKhoanService) {
    ...
    public ResponseEntity<?> createPhieuNhap(@Valid @RequestBody PhieuNhapRequest phieuNhapRequest, @RequestHeader("Authorization") String jwt) throws Exception {
...
//        phieuNhapDTO.setTrangThai("Đã Gửi");
        ...
        for (ChiTietPhieuNhapRequest chiTietPhieuNhap : phieuNhapRequest.getChiTietPhieuNhapList()) {
            ...
            chiTietPhieuNhapDTO.setThanhTien((chiTietPhieuNhap.getSoLuong() * nguyenLieuDTO.getGiaNhap()) + (chiTietPhieuNhap.getSoLuong() * nguyenLieuDTO.getGiaNhap() * nguyenLieuDTO.getvAT())/100);
...
//        phieuNhapDTO1.setTienNo(result.getTienNo());
        ...
        for (ChiTietPhieuNhapRequest chiTietPhieuNhap : phieuNhapRequest.getChiTietPhieuNhapList()) {
            ...
            Long thanhTien = ((chiTietPhieuNhap.getSoLuong() * nguyenLieuDTO.getGiaNhap()) + (chiTietPhieuNhap.getSoLuong() * nguyenLieuDTO.getGiaNhap() * nguyenLieuDTO.getvAT())/100);
...
//        return ResponseEntity.ok(phieuNhapRequest);
    ...
    public ResponseEntity<?> createPhieuNhapByExcelFile(@ModelAttribute PhieuNhapExcelRequest phieuNhapExcelRequest, @RequestHeader("Authorization") String jwt) throws Exception {
...
//        phieuNhapDTO.setTrangThai("Đã Gửi");
        ...
        for (Row chiTietPhieuNhap : sheet) {
            ...
            chiTietPhieuNhapDTO.setNguyenLieu(nguyenLieuDTO);
            chiTietPhieuNhapDTO.setThanhTien((soLuong * nguyenLieuDTO.getGiaNhap()) + (soLuong * nguyenLieuDTO.getGiaNhap() * nguyenLieuDTO.getvAT())/100);
